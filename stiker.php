...
<?php 
	...
	$barang = mysqli_query($conn,"SELECT * FROM tb_barang WHERE NAMA='Stiker'");
						...
						<form action="simpanpinjam.php" method="POST" enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="form-group col-md-6">
									...
									<select id="inputState" v-model="finishing" name="finishing" class="form-control">
										<option selected value="Lepas"> </option>
										<option value="Lem">Laminasi</option>
							...
							<div class="row">
								<div class="form-group col-md-6">
									...
									<input type="text" @change="harrga();totalBiaya()"  v-model="jumlah" name="jumlah" class="form-control">
								</div>
								<div class="form-group col-md-6">
			...
			var app = new Vue ({
				...
				data(){
					...
					methods:{
							...
							// 		this.biaya = 0
							// }
							return this.totalHarga = (parseInt(this.hrg) + this.biaya) * (parseInt(this.jumlah))
					},
					harrga(){
						return this.hrg = (this.luas * parseInt(this.hargastandart))	
					},
