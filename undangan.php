...
<?php 
	...
	$barang = mysqli_query($conn,"SELECT * FROM tb_barang WHERE NAMA='Undangan'");
		...
		<section class="container col-md-8" id="app">
			...
			<div class="card">
				<div class="col-md-12">
					...
					<div class="card-body">
						<form action="simpanundangan.php" method="POST" enctype="multipart/form-data">
							<div class="form-row">
							...
							<div class="row">
								<div class="form-group col-md-4">
									<label for="inputZip">Tanggal Pemesanan</label>
									<input type="text" name="tanggal" class="form-control">
								</div>
								<div class="form-group col-md-4">
									<label for="inputZip">Tanggal Jadi</label>
									<input type="text" v-model="tglJadi" name="tanggal_jadi" class="form-control">
								</div>
								<div class="form-group col-md-4">
									<label for="inputZip">Uang Muka</label>
									<input type="number" v-model="um" name="uangmuka" class="form-control">
								</div>
							</div>
							<div class="row">
								<div class="form-group col-md-6">
									<label for="inputZip">Sisa</label>
									<input type="text" v-model="netto" name="tanggungan" name="sisa" class="form-control">
								</div>
								<div class="form-group col-md-6">
			...
			var app = new Vue ({
				...
				data(){
					...
					methods:{
							...
							// 		this.biaya = 500 * (parseInt(this.jumlah) * 4)
							// 	}else if(this.finishing == 'Selongsong'){
							// 		this.biaya = 1000
							// 	}else if(this.finishing == 'Lepas'){
							// 		this.biaya = 0
							// }
							return this.totalHarga = (parseInt(this.hargastandart)) * (parseInt(this.jumlah))
					...
					jabar(){
						...
						// }).then((res) => {
						// 	console.log(res)
						// 	this.hargastandart = res.data
						// })
						if (this.barang == 4) {this.hargastandart = 1000
						}else if(this.barang == 5 ){
							this.hargastandart = 1200
						}else {
							this.hargastandart = 1500
						}
					}
				}
			})
